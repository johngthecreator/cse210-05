...
namespace Unit05.Game.Scripting
{
    ...
    public class ControlActorsAction : Action
    {
        ...
        private Point _pookieDir = new Point(Constants.CELL_SIZE, 0);
        ...
        public void Execute(Cast cast, Script script)
        {
            ...
            {
                _pookieDir = new Point(-Constants.CELL_SIZE, 0);
            }
            ...
            {
                _pookieDir = new Point(0, -Constants.CELL_SIZE);
            }
